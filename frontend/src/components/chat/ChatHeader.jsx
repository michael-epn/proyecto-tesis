export const ChatHeader = ({ contacto, onBack }) => (
    <div className="bg-slate-800 px-4 md:px-6 py-4 border-b border-slate-700 rounded-t-2xl md:rounded-tl-none md:rounded-tr-2xl flex items-center gap-4">
        <button onClick={onBack} className="md:hidden text-slate-300 hover:text-white transition-colors">
