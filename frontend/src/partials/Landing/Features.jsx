...
function Features() {
  return (
    <section id="solucion" className="relative bg-slate-50 dark:bg-slate-900 py-12 md:py-20 border-t border-slate-200 dark:border-slate-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="grid gap-8 md:grid-cols-3 lg:gap-16 items-start">
            {/* Feature 1 */}
            <div className="flex flex-col items-center p-6 bg-white dark:bg-slate-900 rounded shadow-xl border-t-4 border-[#C8102E]">
