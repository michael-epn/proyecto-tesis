            ...
            <ul className="mt-3">
                ...
                <>
                  ...
                  <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname === '/estudiante' && 'bg-slate-900'}`}>
                    <NavLink end to="/estudiante" className={`block text-slate-200 truncate transition duration-150 ${pathname === '/estudiante' ? 'hover:text-slate-200' : 'hover:text-white'}`}>
                      <div className="flex items-center">
                        <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 duration-200">Generar Tema</span>
                      </div>
                    </NavLink>
                  </li>
              ...
              {rol === 'comision' && (
                <>
                  ...
                  <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname === '/comision/docentes' && 'bg-slate-900'}`}>
