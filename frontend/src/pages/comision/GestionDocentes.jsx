            ...
            <div className="max-w-[1600px] mx-auto">
                <header className="mb-8 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
                    <div className="flex flex-col gap-4">
                        <div>
                            <h2 className="text-3xl font-extrabold text-slate-800 dark:text-slate-200 tracking-tight">Gestión de Docentes y Cupos</h2>
                                        ...
                                        return (
                                            <tr key={docente._id} >
                                                <td className="px-6 py-4 align-middle">
                                                    <div className="font-bold text-slate-800 dark:text-slate-300 text-base">{docente.nombre} {docente.apellido}</div>
                                                    <div className="text-xs font-medium text-slate-500 mt-1">{docente.email}</div>
                                                </td>
                                                <td className="px-6 py-4 align-middle text-center">
                                                    {docente.disponibilidad ? (
                                                        <span className="inline-flex items-center gap-1 px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full text-xs font-bold uppercase tracking-wide border border-emerald-200 dark:border-emerald-800/50">
                                                            Activo
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-1 px-3 py-1 bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400 rounded-full text-xs font-bold uppercase tracking-wide border border-rose-200 dark:border-rose-800/50">
                                                            Pausado
                                                        </span>
                                                    )}
                                                </td>
                                                <td className="px-6 py-4 align-middle">
                                                    <div className="flex flex-col items-center gap-2">
                                                        <span className={`text-sm font-bold ${estaLleno ? 'text-rose-600' : 'text-slate-700 dark:text-slate-400'}`}>
                                                ...
                                                <td className="px-6 py-4 align-middle text-center">
                                                    <label className="relative inline-flex items-center cursor-pointer justify-center">
                                                        ...
                                                        />
                                                        <div 
                                                            className="w-11 h-6 bg-slate-300 dark:bg-slate-700 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-emerald-500 dark:peer-focus:ring-emerald-400 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 dark:after:border-slate-600 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500 dark:peer-checked:bg-emerald-400"
                                                        >
                                                        </div>
