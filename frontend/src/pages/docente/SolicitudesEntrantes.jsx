        ...
        <div className="w-full min-h-screen relative">
            <div className="w-full">
                <header className="mb-8">
                    <h2 className="text-3xl font-extrabold text-slate-800 dark:text-slate-200 tracking-tight">Bandeja de Solicitudes</h2>
                ...
                <div className="bg-white dark:bg-slate-900 shadow-xl rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse dark:text-slate-300">
                            <thead>
                                <tr className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 text-slate-500 text-sm uppercase tracking-wider">
                                    ...
                                    solicitudes.map((sol) => (
                                        <tr key={sol._id}>
                                            <td className="px-6 py-4 align-top">
                                                ...
                                                <div className="text-sm font-medium text-slate-500 dark:text-slate-400 mt-1">{sol.estudiante?.email}</div>
                                            </td>
                                            <td className="px-6 py-4 align-top max-w-xl">
                                                <div className="font-bold text-slate-800 dark:text-slate-200 text-base mb-1">{sol.tema?.titulo}</div>
                                                <div className="text-sm font-medium text-slate-600 dark:text-slate-400 mb-3">{sol.tema?.descripcion}</div>
                                                <div className="flex gap-2 flex-wrap">
                                                    {sol.tema?.tecnologias?.map(t => (
                                                        <span key={t} className="bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 px-2.5 py-1 rounded-full text-xs font-bold">
                                                            {t}
                                                        </span>
                                                    ))}
                                                </div>
                                            ...
                                            <td className="px-6 py-4 align-middle">
                                                <div className="flex flex-col gap-2 justify-center">
                                                    ...
                                                    <button 
                                                        ...
                                                        className="w-full font-bold py-2 px-4 rounded-xl shadow-sm text-sm bg-slate-800 text-white hover:bg-slate-900 dark:hover:bg-slate-700"
                                                    >
                                                        Rechazar
                                                    </button>
                                                </div>
