            ...
            <div className="max-w-[1600px] mx-auto">
                <header className="mb-8 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
                    <div className="flex flex-col gap-4">
                        <div>
                            <h2 className="text-3xl font-extrabold text-slate-800 dark:text-slate-200 tracking-tight">Historial de Tutorías</h2>
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-6 py-3 rounded-xl shadow-sm flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xl font-extrabold text-slate-800 dark:text-slate-200">{cuposOcupados} <span className="text-sm font-medium text-slate-400">estudiantes</span></p>
                            </div>
                        </div>
                        
                        <button 
                            onClick={handleReiniciarCupos}
                            className="w-full flex items-center justify-center gap-2 bg-white dark:bg-slate-900 border border-rose-200 dark:border-slate-800 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 hover:border-rose-300 dark:hover:border-rose-800 font-bold py-2.5 px-4 rounded-xl text-xs shadow-sm"
                        >
                                ...
                                {cargando ? (
                                    ...
                                    historialOrdenado.map((sol) => (
                                        <tr key={sol._id}>
                                            ...
                                            <td className="px-6 py-4 align-top">
                                                <div className="font-medium text-slate-700 dark:text-slate-300">{sol.tema?.titulo}</div>
                                            </td>
